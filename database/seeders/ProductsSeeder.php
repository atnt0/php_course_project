...
Intel Identity Protection Technology',
            ...
            [
                ...
                'description_ru' => 'Надежные конструктивные решения Накопители WD Blue, соответствующие самым высоким требованиям WD в части качества и надежности, обладают вполне достаточной функциональностью и емкостью для решения повседневных задач в системах начального уровня.
                Современная классика Модели WD Blue разработаны и произведены по технологии знаменитых оригинальных накопителей WD для настольных и мобильных компьютеров.

                WD Blue — яркий пример того, какими должны быть накопители для повседневных задач.
                Вот уже шесть поколений их быстродействие неуклонно растет, а качество и надежность остаются традиционно высокими.
                Преимущества WD Прежде чем выпустить в производство любое новое изделие, компания Western Digital тщательно проверяет сохранность его функциональных характеристик в своей тестовой лаборатории.
                Это тестирование позволяет убедиться в том, что наши изделия соответствуют самым высоким нормам качества и надежности продукции.

                Также у компании имеется обширная база знаний, насчитывающая более 1000 статей, и библиотека полезных программ.',
